...
func TestGenGenGen(t *testing.T) {
	...
	WriteDeclaration(ctx, depth, bbTypeDecl)
...
func TestGenDecodeDeepTest(t *testing.T) {
	...
	dt.WriteTreeDecl(&n, values, bbValueTree)
	sValueTree := bbValueTree.String()

	// generate value ref
	dt.WriteValueRef(values, t.Output())
	// dt.EmitValueRef(values, t.Output())
	// dt.EmitValueRef(values, t.Output())
	bbValueRef := bytes.NewBuffer([]byte{})
	dt.WriteValueRef(values, bbValueRef)
...
func TestEmitValueRef1(t *testing.T) {
	...
	fmt.Print("x")
	DeepType{rt}.WriteValueRef(values, t.Output())
	fmt.Println()
}
...
func TestGenDeclaration1(t *testing.T) {
	...
	for range 10 {
		WriteDeclaration(ctx, 1, t.Output())
		t.Output().Write([]byte("\n"))
	}
}
...
func TestGenDeclaration2(t *testing.T) {
	...
	for range 10 {
		WriteDeclaration(ctx, 2, t.Output())
		t.Output().Write([]byte("\n"))
	}
}
...
func TestGenDeclaration100(t *testing.T) {
	...
	WriteDeclaration(ctx, 100, t.Output())
	t.Output().Write([]byte("\n"))
}
...
func TestGenTest10(t *testing.T) {
	...
	// emit tree
	n := 0
	DeepType{reflect.TypeFor[typ]()}.WriteTreeDecl(&n, values, t.Output())

	// emit value ref
	fmt.Print("x")
	DeepType{reflect.TypeFor[typ]()}.WriteValueRef(values, t.Output())
	fmt.Println()
}
...
func TestMapTypeEmitValueRef1a(t *testing.T) {
	...
	mapType.WriteValueRef(values, t.Output())
}
